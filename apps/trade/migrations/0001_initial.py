# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2017-12-22 19:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_status', models.CharField(choices=[('success', '成功'), ('cancel', '取消'), ('paying', '待支付')], max_length=10, verbose_name='订单状态')),
                ('pay_type', models.CharField(choices=[('alipay', '支付宝'), ('wechat', '微信'), ('paypal', 'PayPal')], max_length=10, verbose_name='支付方式')),
