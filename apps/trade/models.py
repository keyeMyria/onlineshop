...
class ShoppingCart(models.Model):
    ...
    def __str__(self):
        return "%s(%d)".format(self.goods.name, self.nums)    # not sure goods_num
...
class OrderInfo(models.Model):
    ...
    trade_no = models.CharField(max_length=100, unique=True, null=True, blank=True, verbose_name="交易号")     # 第三方支付交易号
