...
class Goods(models.Model):
    ...
    goods_num = models.IntegerField(default=0, verbose_name="库存数")   # merchandise inventory
    market_price = models.FloatField(default=0, verbose_name="市场价格")
    shop_price = models.FloatField(default=0, verbose_name="本店价格")
    goods_brief = models.TextField(max_length=500, verbose_name="商品简短描述")    # a little long, use TextField()
    goods_desc = UEditorField(verbose_name=u"内容", imagePath="goods/images/", width=800, height=300, filePath="goods/files/", default="")
    ship_free = models.BooleanField(default=True, verbose_name="是否承担运费")
    goods_front_image = models.ImageField(upload_to="goods/images/", null=True, blank=True, verbose_name="封面图")    # goods cover pic
